...
# Throttle abusive requests (e.g. brute-force login attempts on /admin)
gem "rack-attack"
...
# Admin CRUD for internal data management
gem "administrate"

# Soft delete (admin recovery from fat-fingered deletes)
gem "discard"
...
group :development do
  ...
  # Annotate models with schema info at top of file
  gem "annotaterb"
end
